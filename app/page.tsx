  ...
  return (
    <BaseLayout>
      <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
        ...
        <div className="relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 sm:py-32">
            <div className="text-center">
              <h1 className="text-3xl sm:text-6xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 leading-tight">
        ...
        <div className="bg-white dark:bg-gray-800 py-12 sm:py-16 transition-colors duration-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-6 px-4 text-gray-900 dark:text-white section-heading">
              Quick Access
            </h2>
        ...
        <div className="py-12 sm:py-16 bg-brown-50 dark:bg-gray-900 transition-colors duration-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4 section-heading">
        ...
        <div className="bg-white dark:bg-gray-800 py-12 sm:py-16 transition-colors duration-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {/* Blue Tokai */}
              <div className="bg-brown-50 dark:bg-gray-700 rounded-lg p-6 hover:bg-brown-100 dark:hover:bg-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Blue Tokai Coffee Roasters</h3>
                    <p className="text-brown-600 dark:text-brown-200">Est. 2013 • Delhi/Bangalore</p>
                  </div>
                  <span className="bg-brown-100 dark:bg-brown-600 text-brown-800 dark:text-brown-100 px-3 py-1 rounded-full text-sm">Premium</span>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Specialty</span>
                    <span className="dark:text-gray-300">Light to medium roasts, Single origins</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Price Range</span>
                    <span className="dark:text-gray-300">₹400 - ₹800</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Best For</span>
                    <span className="dark:text-gray-300">Pour over, French press, Cold brew</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-brown-50 dark:bg-gray-700 rounded-lg p-6 hover:bg-brown-100 dark:hover:bg-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">KC Roasters</h3>
                    <p className="text-brown-600 dark:text-brown-200">Est. 2017 • Mumbai</p>
                  </div>
                  <span className="bg-brown-100 dark:bg-brown-600 text-brown-800 dark:text-brown-100 px-3 py-1 rounded-full text-sm">Artisanal</span>
                </div>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Specialty</span>
                    <span className="dark:text-gray-300">Natural process, Experimental lots</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Price Range</span>
                    <span className="dark:text-gray-300">₹500 - ₹1000</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Best For</span>
                    <span className="dark:text-gray-300">Espresso, Pour over, Aeropress</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-brown-50 dark:bg-gray-700 rounded-lg p-6 hover:bg-brown-100 dark:hover:bg-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Third Wave Coffee Roasters</h3>
                    <p className="text-brown-600 dark:text-brown-200">Est. 2016 • Bangalore</p>
                  </div>
                  <span className="bg-brown-100 dark:bg-brown-600 text-brown-800 dark:text-brown-100 px-3 py-1 rounded-full text-sm">Cafe Chain</span>
                </div>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Specialty</span>
                    <span className="dark:text-gray-300">Medium roasts, Blends</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Price Range</span>
                    <span className="dark:text-gray-300">₹350 - ₹600</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Best For</span>
                    <span className="dark:text-gray-300">Espresso, Cold brew</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-brown-50 dark:bg-gray-700 rounded-lg p-6 hover:bg-brown-100 dark:hover:bg-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Curious Life Coffee</h3>
                    <p className="text-brown-600 dark:text-brown-200">Est. 2018 • Bangalore</p>
                  </div>
                  <span className="bg-brown-100 dark:bg-brown-600 text-brown-800 dark:text-brown-100 px-3 py-1 rounded-full text-sm">Boutique</span>
                </div>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Specialty</span>
                    <span className="dark:text-gray-300">Light roasts, Seasonal offerings</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Price Range</span>
                    <span className="dark:text-gray-300">₹450 - ₹750</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Best For</span>
                    <span className="dark:text-gray-300">Pour over, Filter coffee</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-brown-50 dark:bg-gray-700 rounded-lg p-6 hover:bg-brown-100 dark:hover:bg-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Black Baza Coffee</h3>
                    <p className="text-brown-600 dark:text-brown-200">Est. 2016 • Bangalore</p>
                  </div>
                  <span className="bg-brown-100 dark:bg-brown-600 text-brown-800 dark:text-brown-100 px-3 py-1 rounded-full text-sm">Sustainable</span>
                </div>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Specialty</span>
                    <span className="dark:text-gray-300">Shade-grown, Organic</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Price Range</span>
                    <span className="dark:text-gray-300">₹400 - ₹700</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Best For</span>
                    <span className="dark:text-gray-300">Filter coffee, French press</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-brown-50 dark:bg-gray-700 rounded-lg p-6 hover:bg-brown-100 dark:hover:bg-gray-600 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Dope Coffee Roasters</h3>
                    <p className="text-brown-600 dark:text-brown-200">Est. 2017 • Mumbai</p>
                  </div>
                  <span className="bg-brown-100 dark:bg-brown-600 text-brown-800 dark:text-brown-100 px-3 py-1 rounded-full text-sm">Modern</span>
                </div>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Specialty</span>
                    <span className="dark:text-gray-300">Modern blends, Dark roasts</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Price Range</span>
                    <span className="dark:text-gray-300">₹450 - ₹800</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <span className="text-brown-800 dark:text-brown-200 font-medium w-24">Best For</span>
                    <span className="dark:text-gray-300">Espresso, Cold brew</span>
